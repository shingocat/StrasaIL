...
//	for graph options;
	...
	private PyramidedLineAnalysisModel pyramidedLineAnalysisModel;
			...
			@ContextParam(ContextType.VIEW) Component view)
	{
		...
		pyramidedLineAnalysisModel = new PyramidedLineAnalysisModel();
