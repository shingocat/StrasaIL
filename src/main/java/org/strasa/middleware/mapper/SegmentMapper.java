...
public interface SegmentMapper {
     ...
     */
    @Delete(
    { "delete from segment", "where segment_id = #{segmentId,jdbcType=INTEGER}" })
    ...
    @Insert(
    {
            ...
            "description)",
            "values (#{chromosome,jdbcType=VARCHAR}, #{recurrentParent,jdbcType=VARCHAR}, ",
    ...
    @Results(
    {
            ...
            @Result(column = "chromosome", property = "chromosome", jdbcType = JdbcType.VARCHAR),
     ...
     */
    @Update(
    { "update segment", "set chromosome = #{chromosome,jdbcType=VARCHAR},",
